<html>
  <head>
	...
	h1 { color: #777; font-weight: normal; font-size: 24px; margin: 0; margin-left: 5px; } 
	tr { border-bottom: 1px solid #CCC; padding: 15px 0; display: block; } 
	...
	.item-link, .item-link:hover, .item-link:visited, .item-link:active { text-decoration: none; color: #333; } 
  ...
  document.write('<form action="https://svcs.ebay.com/services/search/FindingService/v1" method="GET"><input type="text" name="SECURITY-APPNAME" value="JunchaoL-mytestin-PRD-29a64d344-9adc46d3" /><input name="OPERATION-NAME" value="findItemsByKeywords" /><input name="SERVICE-VERSION" value="1.0.0" /><input name="RESPONSE-DATA-FORMAT" value="JSON" /><input name="callback" value="_cb_findItemsByKeywords" /><input name="keywords" value="iPhone" /><input name="paginationInput.entriesPerPage" value="1" /><input name="GLOBAL-ID" value="EBAY-US" /><input name="siteid" value="0" /><input type="submit" value="search" /></form>');
    </script>
</body>
</html>
